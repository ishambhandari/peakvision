...
var Feedback = React2.forwardRef(({
  as: Component = "div",
  className,
  type = "valid",
  tooltip = false,
  ...props
}, ref) => (0, import_jsx_runtime2.jsx)(Component, {
  ...props,
  ref,
...
var FloatingLabel = React12.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
  ...
  return (0, import_jsx_runtime14.jsxs)(FormGroup_default, {
    ref,
    className: (0, import_classnames10.default)(className, bsPrefix),
    controlId,
    ...props,
    children: [children, (0, import_jsx_runtime13.jsx)("label", {
      htmlFor: controlId,
      children: label
    })]
  });
...
var Switch = React14.forwardRef((props, ref) => (0, import_jsx_runtime16.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
//# sourceMappingURL=chunk-KADBMNO6.js.map
