...
import {
  ...
  useNavItem
} from "./chunk-ZIA54ROW.js";
import {
  CardImg_default,
  Card_default
} from "./chunk-WCEFM56K.js";
import "./chunk-WBRH25ON.js";
import {
  Col_default,
  ...
  require_warning,
  useCol
} from "./chunk-KADBMNO6.js";
import {
  forEach,
  map
} from "./chunk-QHOOMTYU.js";
import {
...
import {
  ...
  useMounted,
  usePrevious
} from "./chunk-JHBTLQ5Q.js";
import {
  divWithClassName_default
} from "./chunk-FIRXB5MX.js";
import {
  Spinner_default
} from "./chunk-XSGA6LAR.js";
import {
  TabContainer_default,
  Tab_default
} from "./chunk-K2C6UNKC.js";
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-5NFUPJGD.js";
import "./chunk-GCEFSD4J.js";
import {
  ENTERED,
  ENTERING,
  EXITED,
...
} from "./chunk-HPHLVW5O.js";
import {
  require_react_dom
} from "./chunk-RWJV36H2.js";
import {
  require_prop_types
} from "./chunk-IUVKFNFK.js";
import "./chunk-FXIKXRN7.js";
import {
  createWithBsPrefix
} from "./chunk-YQXJ6UYA.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-66KDJDDT.js";
import {
  require_classnames
} from "./chunk-FNBUSOP2.js";
import {
  require_react
...
var Alert = React10.forwardRef((uncontrolledProps, ref) => {
  const {
    bsPrefix,
    show,
    closeLabel,
...
Badge.defaultProps = defaultProps3;
...
BreadcrumbItem.defaultProps = defaultProps4;
...
Breadcrumb.defaultProps = defaultProps5;
...
var Button = React14.forwardRef(({
  ...
  return (0, import_jsx_runtime13.jsx)(Component2, {
    ...
    ...props,
    ref,
    className: (0, import_classnames12.default)(className, prefix, active && "active", variant && `${prefix}-${variant}`, size && `${prefix}-${size}`, props.href && props.disabled && "disabled")
  });
});
...
function useTimeout() {
  ...
  var handleRef = (0, import_react8.useRef)();
...
var CarouselItem = React17.forwardRef(({
  as: Component2 = "div",
  bsPrefix,
  className,
  ...props
}, ref) => {
  const finalClassName = (0, import_classnames15.default)(className, useBootstrapPrefix(bsPrefix, "carousel-item"));
...
var defaultProps9 = {
  ...
  wrap: true,
  touch: true,
  prevIcon: (0, import_jsx_runtime17.jsx)("span", {
    "aria-hidden": "true",
    className: "carousel-control-prev-icon"
  }),
  prevLabel: "Previous",
  nextIcon: (0, import_jsx_runtime17.jsx)("span", {
    "aria-hidden": "true",
...
var Carousel = React18.forwardRef((uncontrolledProps, ref) => {
  const {
    as: Component2 = "div",
    bsPrefix,
    slide,
  ...
  return (0, import_jsx_runtime18.jsxs)(Component2, {
    ref: elementRef,
    ...props,
    ...
    className: (0, import_classnames16.default)(className, prefix, slide && "slide", fade && `${prefix}-fade`, variant && `${prefix}-${variant}`),
    children: [indicators && (0, import_jsx_runtime17.jsx)("div", {
      className: `${prefix}-indicators`,
      children: map(children, (_, index) => (0, import_jsx_runtime17.jsx)("button", {
        type: "button",
        "data-bs-target": "",
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime17.jsx)(TransitionWrapper_default, {
          in: isActive,
          onEnter: isActive ? handleEnter : void 0,
          onEntered: isActive ? handleEntered : void 0,
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React18.cloneElement(child, {
            ...innerProps,
    ...
    }), controls && (0, import_jsx_runtime18.jsxs)(import_jsx_runtime19.Fragment, {
      children: [(wrap || activeIndex !== 0) && (0, import_jsx_runtime18.jsxs)(Anchor_default, {
        className: `${prefix}-control-prev`,
        onClick: prev,
        children: [prevIcon, prevLabel && (0, import_jsx_runtime17.jsx)("span", {
          className: "visually-hidden",
          children: prevLabel
        })]
      }), (wrap || activeIndex !== numChildren - 1) && (0, import_jsx_runtime18.jsxs)(Anchor_default, {
        className: `${prefix}-control-next`,
        onClick: next,
        children: [nextIcon, nextLabel && (0, import_jsx_runtime17.jsx)("span", {
          className: "visually-hidden",
          children: nextLabel
        })]
      })]
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react10.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
function DropdownMenu(_ref) {
  ...
  return (0, import_jsx_runtime21.jsx)(import_jsx_runtime20.Fragment, {
...
var DropdownItem = React22.forwardRef((_ref, ref) => {
  let {
    eventKey,
    disabled,
    onClick,
  ...
  return (0, import_jsx_runtime24.jsx)(Component2, Object.assign({}, props, {
    ref
  }, dropdownItemProps));
});
...
function Dropdown({
  ...
  const context4 = (0, import_react16.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  return (0, import_jsx_runtime25.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime25.jsx)(DropdownContext_default.Provider, {
      value: context4,
      children
    })
  });
...
var DropdownContext2 = React24.createContext({});
...
var DropdownItem2 = React25.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
  ...
  return (0, import_jsx_runtime26.jsx)(Component2, {
    ...
    ...dropdownItemProps,
    ref,
    className: (0, import_classnames17.default)(className, prefix, meta.isActive && "active", disabled && "disabled")
  });
});
...
var DropdownMenu2 = React27.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
  ...
  return (0, import_jsx_runtime27.jsx)(Component2, {
    ...
    className: (0, import_classnames18.default)(className, prefix, show && "show", alignEnd && `${prefix}-end`, variant && `${prefix}-${variant}`, ...alignClasses)
  });
});
...
var DropdownToggle2 = React28.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
  ...
  return (0, import_jsx_runtime28.jsx)(Component2, {
    className: (0, import_classnames19.default)(className, prefix, split && `${prefix}-split`, !!isInputGroup && (dropdownContext == null ? void 0 : dropdownContext.show) && "show"),
    ...toggleProps,
    ...props
  });
});
...
var Dropdown2 = React29.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop,
    show,
  ...
  return (0, import_jsx_runtime29.jsx)(DropdownContext_default2.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime29.jsx)(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : (0, import_jsx_runtime29.jsx)(Component2, {
        ...props,
        ref,
        className: (0, import_classnames20.default)(className, show && "show", (!drop || drop === "down") && prefix, drop === "up" && "dropup", drop === "end" && "dropend", drop === "start" && "dropstart")
      })
    })
  });
});
Dropdown2.displayName = "Dropdown";
Dropdown2.defaultProps = defaultProps12;
...
var DropdownButton = React30.forwardRef(({
  title,
  children,
  bsPrefix,
  rootCloseEvent,
  ...
  menuVariant,
  ...props
}, ref) => (0, import_jsx_runtime31.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  children: [(0, import_jsx_runtime30.jsx)(DropdownToggle_default2, {
    id,
    href,
    size,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime30.jsx)(DropdownMenu_default2, {
    role: menuRole,
...
Container.defaultProps = defaultProps13;
...
var Image = React32.forwardRef(({
  ...
  return (0, import_jsx_runtime33.jsx)("img", {
    ref,
    ...props,
    className: (0, import_classnames22.default)(className, fluid && `${bsPrefix}-fluid`, rounded && `rounded`, roundedCircle && `rounded-circle`, thumbnail && `${bsPrefix}-thumbnail`)
  });
});
Image.displayName = "Image";
Image.defaultProps = defaultProps14;
...
var FigureImage = React33.forwardRef(({
  ...
  ref,
  ...props,
  className: (0, import_classnames23.default)(className, "figure-img")
}));
FigureImage.displayName = "FigureImage";
FigureImage.propTypes = propTypes2;
FigureImage.defaultProps = defaultProps15;
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime35.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime35.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime35.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime35.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React34.forwardRef(({
  ...
  return (0, import_jsx_runtime35.jsx)(InputGroupContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime35.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames24.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var ListGroupItem = React35.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React36.forwardRef((props, ref) => {
  const {
    className,
  ...
  return (0, import_jsx_runtime37.jsx)(Nav_default, {
    ref,
    ...controlledProps,
    as,
...
var NavbarCollapse = React38.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context4 = (0, import_react22.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime39.jsx)(Collapse_default, {
...
var NavbarToggle = React39.forwardRef(({
  bsPrefix,
  className,
  children,
  label,
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react23.useContext)(NavbarContext_default) || {};
  ...
  return (0, import_jsx_runtime40.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime40.jsx)("span", {
      className: `${bsPrefix}-icon`
    })
  });
});
NavbarToggle.displayName = "NavbarToggle";
NavbarToggle.defaultProps = defaultProps16;
...
function useMediaQuery(query, targetWindow) {
  ...
  var _useState = (0, import_react24.useState)(function() {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react25.useMemo)(function() {
...
var OffcanvasToggling = React40.forwardRef(({
  bsPrefix,
  className,
  children,
  ...props
  ...
  return (0, import_jsx_runtime41.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React40.cloneElement(children, {
      ...innerProps,
...
OffcanvasToggling.defaultProps = defaultProps17;
...
var OffcanvasHeader = React41.forwardRef(({
  bsPrefix,
  className,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas-header");
  return (0, import_jsx_runtime42.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
OffcanvasHeader.defaultProps = defaultProps18;
...
function DialogTransition(props) {
  return (0, import_jsx_runtime43.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition(props) {
  return (0, import_jsx_runtime43.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React42.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const modalManager = (0, import_react26.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react26.useContext)(NavbarContext_default) || {};
  ...
  const renderBackdrop = (0, import_react26.useCallback)((backdropProps) => (0, import_jsx_runtime43.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames31.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime43.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    ...props,
    className: (0, import_classnames31.default)(className, bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime43.jsx)(ModalContext_default.Provider, {
    value: modalContext,
    children: (0, import_jsx_runtime43.jsx)(Modal_default, {
      show,
      ref,
      backdrop,
      container,
...
Offcanvas.defaultProps = defaultProps19;
...
var NavbarOffcanvas = React43.forwardRef(({
  className,
  bsPrefix,
  backdrop,
  backdropClassName,
  ...
  const context4 = (0, import_react27.useContext)(NavbarContext_default);
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const hasExpandProp = typeof (context4 == null ? void 0 : context4.expand) === "string";
  const shouldExpand = useBreakpoint_default(hasExpandProp ? context4.expand : "xs", "up");
  return hasExpandProp && shouldExpand ? (0, import_jsx_runtime44.jsx)("div", {
    ref,
    ...props,
    className: (0, import_classnames32.default)(className, bsPrefix, `${bsPrefix}-${placement}`)
  }) : (0, import_jsx_runtime44.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React44.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand,
    variant,
  ...
  const handleCollapse = (0, import_react28.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react28.useMemo)(() => ({
    onToggle: () => onToggle == null ? void 0 : onToggle(!expanded),
    bsPrefix,
    expanded: !!expanded,
    expand
  }), [bsPrefix, expanded, expand, onToggle]);
  return (0, import_jsx_runtime45.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime45.jsx)(SelectableContext_default.Provider, {
      value: handleCollapse,
      children: (0, import_jsx_runtime45.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames33.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
Navbar.defaultProps = defaultProps20;
...
var NavDropdown = React45.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime47.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames34.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime46.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime46.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
var Overlay = React46.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime48.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
var Popover = React48.forwardRef(({
  bsPrefix,
  placement,
  className,
  style,
  ...
  return (0, import_jsx_runtime50.jsxs)("div", {
    ref,
    role: "tooltip",
    style,
    ...
    children: [(0, import_jsx_runtime49.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime49.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
Popover.defaultProps = defaultProps21;
...
var Overlay2 = React49.forwardRef(({
  children: overlay,
  transition,
  popperConfig = {},
  ...outerProps
  ...
  return (0, import_jsx_runtime51.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React49.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
        className: (0, import_classnames36.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
Overlay2.defaultProps = defaultProps22;
...
function OverlayTrigger({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React50.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime54.jsxs)(import_jsx_runtime53.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react33.cloneElement)(children, triggerProps), (0, import_jsx_runtime52.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
OverlayTrigger.defaultProps = defaultProps23;
...
var PageItem = React51.forwardRef(({
  active,
  disabled,
  className,
  style,
  ...
  return (0, import_jsx_runtime55.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames37.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime56.jsxs)(Component2, {
      className: "page-link",
      disabled,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime55.jsx)("span", {
        className: "visually-hidden",
...
PageItem.defaultProps = defaultProps24;
PageItem.displayName = "PageItem";
var PageItem_default = PageItem;
function createButton(name, defaultValue, label = name) {
  const Button2 = React51.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime56.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React52.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames38.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames39.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React53.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime58.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React54.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime60.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames40.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime60.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React55.forwardRef(({
  isChild,
  ...props
}, ref) => {
...
var Ratio = React56.forwardRef(({
  ...
  return (0, import_jsx_runtime61.jsx)("div", {
    ...
    className: (0, import_classnames41.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React56.Children.only(children)
  });
});
Ratio.defaultProps = defaultProps26;
...
var SplitButton = React58.forwardRef(({
  id,
  bsPrefix,
  size,
  variant,
  ...
  rootCloseEvent,
  ...props
}, ref) => (0, import_jsx_runtime64.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime63.jsx)(Button_default2, {
    size,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime63.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size,
    variant,
  ...
  }), (0, import_jsx_runtime63.jsx)(Dropdown_default2.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    children
...
var ToastFade = React60.forwardRef((props, ref) => (0, import_jsx_runtime66.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React62.forwardRef(({
  ...
  const context4 = (0, import_react35.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
ToastHeader.defaultProps = defaultProps28;
...
var Toast = React63.forwardRef(({
  ...
  const delayRef = (0, import_react36.useRef)(delay);
  const onCloseRef = (0, import_react36.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react36.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react36.useMemo)(() => ({
    onClose
  }), [onClose]);
  const hasAnimation = !!(Transition && animation);
  const toast = (0, import_jsx_runtime69.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime69.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime69.jsx)(Transition, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
var ToastContainer = React64.forwardRef(({
  ...
  return (0, import_jsx_runtime70.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames46.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
...
var ToggleButton = React65.forwardRef(({
  ...
  return (0, import_jsx_runtime73.jsxs)(import_jsx_runtime72.Fragment, {
    children: [(0, import_jsx_runtime71.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime71.jsx)(Button_default2, {
      ...props,
      ref,
...
var ToggleButtonGroup = React66.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime74.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
...
ToggleButtonGroup.defaultProps = defaultProps29;
