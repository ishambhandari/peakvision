...
var AbstractModalHeader = React4.forwardRef(({
  closeLabel,
  closeVariant,
  closeButton,
  onHide,
...
AbstractModalHeader.defaultProps = defaultProps2;
...
var ModalHeader = React5.forwardRef(({
  bsPrefix,
  className,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal-header");
  return (0, import_jsx_runtime5.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
ModalHeader.defaultProps = defaultProps3;
...
function useUpdatedRef(value) {
  var valueRef = (0, import_react2.useRef)(value);
...
var Context = (0, import_react4.createContext)(canUseDOM_default ? window : void 0);
...
var Modal = (0, import_react6.forwardRef)((_ref, ref) => {
  ...
  if (Transition) {
    dialog = (0, import_jsx_runtime6.jsx)(Transition, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition2) {
      backdropElement = (0, import_jsx_runtime6.jsx)(BackdropTransition2, {
        appear: true,
        in: !!show,
...
var Modal2 = React7.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react7.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react7.useState)(false);
  const waitingForMouseUpRef = (0, import_react7.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react7.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react7.useRef)(null);
  ...
  const renderBackdrop = (0, import_react7.useCallback)((backdropProps) => (0, import_jsx_runtime9.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames4.default)(`${bsPrefix}-backdrop`, backdropClassName, !animation && "show")
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime9.jsx)("div", {
    ...
    className: (0, import_classnames4.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`),
    onClick: backdrop ? handleClick : void 0,
    onMouseUp: handleMouseUp,
    "aria-label": ariaLabel,
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime9.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime9.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
Modal2.defaultProps = defaultProps4;
...
//# sourceMappingURL=chunk-GVWBSJZT.js.map
