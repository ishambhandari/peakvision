...
function useForceUpdate() {
  var _useReducer = (0, import_react10.useReducer)(function(state) {
    return !state;
...
var Nav = React6.forwardRef((_ref, ref) => {
  ...
  const needsRefocusRef = (0, import_react11.useRef)(false);
  const parentOnSelect = (0, import_react11.useContext)(SelectableContext_default);
  const tabContext = (0, import_react11.useContext)(TabContext_default);
  ...
  const listNode = (0, import_react11.useRef)(null);
  ...
  return (0, import_jsx_runtime5.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime5.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime5.jsx)(Component, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime7.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
...
//# sourceMappingURL=chunk-ZIA54ROW.js.map
